...
function Dynamodblist({ refreshKey }) {
  ...
  const fetchData = async () => {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/dynamo/getallusers`
      );
  ...
  const Update = async (event) => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/dynamo/updateuser/${id}`,
        {
          method: "PUT",
  ...
  const Delete = async (id) => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/dynamo/deleteuser/${id}`,
        { method: "DELETE" }
      );
      if (res.ok) {
