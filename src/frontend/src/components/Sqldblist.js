...
function Sqldblist({ refreshKey }) {
  ...
  const fetchData = async () => {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/sql/getallusers`
      );
  ...
  const Update = async (event) => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/sql/updateuser/${id}`,
        {
          method: "PUT",
  ...
  const Delete = async (id) => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/sql/deleteuser/${id}`,
        { method: "DELETE" }
      );
      if (res.ok) {
